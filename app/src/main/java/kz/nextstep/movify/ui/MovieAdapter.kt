...
class MovieAdapter(
    context: Context,
    private val tmdbMovieList: MutableList<TmdbMovie>
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        val date: Date = simpleDateFormat.parse(tmdbMovie.release_date)

        simpleDateFormat = SimpleDateFormat("MMM dd, yyyy")
        val releaseDate: String = simpleDateFormat.format(date)
